...
```{r}
sgpUrl <- paste0("https://developer.bluedot.global/casecounts/locations/1880251?startDate=", startDate, "&endDate", endDate, "&isAggregated=false&includeSources=true&api-version=v1")
...
```{r}
malariaUrl <- paste0("https://developer.bluedot.global/casecounts/diseases/141?locationIds=1820814,%201831722,%201643084,%201655842,%201733045,%201327865,%201694008,%201880251,%201605651,%201562822,%201861060,%201835841,%201814991&startDate=2023-01-01&endDate=", endDate, "&isAggregated=true&api-version=v1")
...
```{r}
rabiesUrl <- paste0("https://developer.bluedot.global/casecounts/diseases/43?locationIds=1820814,%201831722,%201643084,%201655842,%201733045,%201327865,%201694008,%201880251,%201605651,%201562822,%201861060,%201835841,%201814991&startDate=2023-01-01&endDate=", "2023-12-10", "&isAggregated=true&api-version=v1")
