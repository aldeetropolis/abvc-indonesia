...
# Aggregate Event-based Data from Bluedot among AMS
```{r}
...
ams_event_aggr |> select(!c(name, reportedDate, locationName, locationId, latitude, longitude, locationType, sources)) |> gt()
```
...
other_event_aggr |> select(!c(name, reportedDate, locationName, locationId, latitude, longitude, locationType, sources)) |> gt()
```
...
disease_aggr |> select(!c(name, reportedDate, locationId, locationName, latitude, longitude, locationType, sources)) |> gt()
```
