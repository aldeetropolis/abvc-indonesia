...
url <- paste0("https://developer.bluedot.global/casecounts/?diseaseIds=", disease, "&locationIds=", ams, "&startDate=", startDate, "&endDate=", endDate, "&isAggregated=TRUE&includeSources=FALSE&includeCsv=FALSE&api-version=v1")
...
for (i in disease){
  url <- paste0("https://developer.bluedot.global/casecounts/diseases/", i, "?locationIds=", ams, "&startDate=2024-01-01&endDate=", endDate, "&isAggregated=true&api-version=v1")
  res <- GET(url, add_headers("Ocp-Apim-Subscription-Key" = "5f645982e25d4a729d7292b890a8ed31", "Cache-Control" = "no-cache")) |> content()
  data <- enframe(pluck(res, "data")) |> unnest_wider(value)
