...
```{r}
brnUrl <- paste0("https://developer.bluedot.global/casecounts/locations/1820814?startDate=", startDate, "&endDate=", endDate, "&isAggregated=true&subLocationTypes=4&includeSources=false&api-version=v1")
res <- GET(brnUrl, add_headers("Ocp-Apim-Subscription-Key" = "5f645982e25d4a729d7292b890a8ed31", "Cache-Control" = "no-cache")) |> content()
...
```{r}
khmUrl <- paste0("https://developer.bluedot.global/casecounts/locations/1831722?startDate=", startDate, "&endDate=", endDate, "&isAggregated=false&subLocationTypes=4&includeSources=true&api-version=v1")
...
```{r}
sgpUrl <- paste0("https://developer.bluedot.global/casecounts/indicator-based/?locationIds=1880251&startDate=", startDate, "&sourceOrgNames=Ministry%20of%20Health%20Singapore&api-version=v1")
res <- GET(sgpUrl, add_headers("Ocp-Apim-Subscription-Key" = "5f645982e25d4a729d7292b890a8ed31", "Cache-Control" = "no-cache")) |> content()
sgpData <- enframe(pluck(res, "data")) |> unnest_wider(value) |> select(diseaseName, reportingPeriodStartDate, reportingPeriodEndDate, reportingPeriodEndEpiWeek, totalReportedCases, totalConfirmedCases, totalDeaths, sourceDatasetName, sourceDatasetURL, sourceDatasetCitation, sourceOrgName)
flextable(sgpData)
```
