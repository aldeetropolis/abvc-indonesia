...
# Disease Event from Bluedot Human Disease and Case API among AMS
```{r}
url <- paste0("https://developer.bluedot.global/casecounts/?diseaseIds=", "10", "&subLocationTypes=4&startDate=", startDate, "&endDate=", endDate, "&isAggregated=FALSE&includeSources=TRUE&includeCsv=FALSE&api-version=v1")
res <- GET(url, add_headers("Ocp-Apim-Subscription-Key" = "52bd528ca9cd407394791ca418a7b409", "Cache-Control" = "no-cache")) |> content()
disease_event <- enframe(pluck(res, "data")) |> unnest_wider(value) |> filter(countryId %in% c(1880251,1605651,1694008,1820814,1733045,1643084,1831722,1327865,1655842,1562822)) |> 
...
url <- paste0("https://developer.bluedot.global/casecounts/?diseaseIds=", mmwr, "&locationIds=", ams, "&startDate=2024-01-01&endDate=", endDate, "&isAggregated=TRUE&includeSources=FALSE&includeCsv=FALSE&api-version=v1")
