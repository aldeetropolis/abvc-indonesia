...
## From Event-based
```{r}
url <- paste0("https://developer.bluedot.global/casecounts/?diseaseIds=64&subLocationTypes=4&startDate=2024-01-01&isAggregated=FALSE&includeSources=TRUE&includeCsv=FALSE&api-version=v1")
res <- GET(url, add_headers("Ocp-Apim-Subscription-Key" = "52bd528ca9cd407394791ca418a7b409", "Cache-Control" = "no-cache")) |> content()
