---
title: "ABVC Dengue Focus Report June 2023"
author: "Aldilas AN"
date: "2023-06-26"
output: pdf_document
---
...
ggplot(data = filter(dataMlyCase, !is.na(totalCases))) +
  geom_bar(aes(x = date, y = totalCases), color = "red", stat = "identity") +
...
ggplot(data = dataThaiCase) +
  geom_bar(aes(x = date, y = totalCases), colour = "red", stat = "identity") +
...
dataVietCase <- select(dataVietCase, date, week, totalCases)
...
dataCbdCase <- select(dataCbdCase, date, week, totalCases)
...
dataLaoCase <- select(dataLaoCase, date, week, totalCases)
...
ggplot(data = dataLaoCase) +
  geom_bar(aes(x = date, y = totalCases), linewidth = 0.8, colour = "red", stat = "identity") +
  # geom_point(aes(x = week, y = totalCases, colour = Year)) +
  xlab("Epidemiological Week") +
  ylab("Number of Cases") +
  # scale_x_continuous(breaks = seq(1, 53, 13), limits = c(0, 53), expand = c(0,0)) +
...
ggplot(data = dataPhilCase) +
  geom_bar(aes(date, totalCases), linewidth = 0.8, colour = "red", stat = "identity") +
...
ggplot(data = dataIdnCase) +
  geom_bar(aes(x = date, y = totalCases), linewidth = 1, color = "red", stat = "identity") +
...
## Export as Excel file
```{r}
write_xlsx(dataMyrCase, "myanmar-dengue.xlsx")
```
...
ggplot(data = dataAsean) +
  geom_bar(aes(x = date, y = total), colour = "red", stat = "identity") +
