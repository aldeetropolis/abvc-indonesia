...
```{r export}
png("weekly curve COVID-19 ASEAN 31 August 2023 area.png", units="px", width=3400, height=2250, res=300)
plot
dev.off()
```
...
```{r}
covUrl <- "https://developer.bluedot.global/casecounts/indicator-based/?diseaseIds=200&locationIds=1880251,%201605651,%201694008,%201820814,%201733045,%201643084,%201831722,%201327865,%201655842,1562822&startDate=2023-08-25&endDate=2023-08-31&api-version=v1"
