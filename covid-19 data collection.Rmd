...
```{r export}
jpeg("epicurve COVID-19 ASEAN 13 July 2023.jpeg", units="px", width=4000, height=2250, res=300)
plot
dev.off()
```
...
```{r export}
png("weekly curve COVID-19 ASEAN 13 July 2023 area.png", units="px", width=4000, height=2250, res=300)
plot
dev.off()
```
