...
plot <- ggplot() +
  ...
  geom_line(data = weeklyDeath, aes(date, death, colour = "Number of Death"), linetype = "solid", linewidth = 1.2)
...
+
  ...
  scale_x_date(breaks = "1 month", labels = date_format("%b-%Y"),
               limits = as.Date(c('2023-01-01','2023-09-28')), name = element_blank()) +
